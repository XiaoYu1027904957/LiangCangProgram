...
public class GoodSProduceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final List<PinPaiDetialBean.DataBean.ItemsBean> datas;
    private  Context mContext;

    private LayoutInflater inflater;

    public GoodSProduceAdapter(Context mContext, List<PinPaiDetialBean.DataBean.ItemsBean> datas) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(PinPaiDetialBean.DataBean.ItemsBean itemsBean) {
