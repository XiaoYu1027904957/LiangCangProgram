package com.xiaoyu.liangcangprogram.daren;
...
public class DaRenShowDetialsActivity extends AppCompatActivity {
    ...
    private void parseDataDetials(String json) {
        ...
        adapter.setOnItemClickListener(new DarenLikeAdapter.OnItemClickListener() {
            ...
            public void getPosition(int position) {
                ...
                Intent intent = new Intent(DaRenShowDetialsActivity.this, ShowGoodsInfoActivity.class);
